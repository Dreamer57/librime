...
//
#ifndef RIME_SPELLER_R_H_
#define RIME_SPELLER_R_H_
...
class SpellerR : public Processor {
 public:
  SpellerR(const Ticket& ticket);
 ...
 protected:
  ...
  bool AutoSelectByRegex(Context* ctx, const char& input_char);
  ...
  bool auto_select_previous_ = false;
};

}  // namespace rime

#endif  // RIME_SPELLER_R_H_
