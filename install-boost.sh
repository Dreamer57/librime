...
# boost_tarball_sha256sum_1_81_0='71feeed900fbccca04a3b4f2f84a7c217186f28a940ed8b7ed4725986baf99fa  boost_1_81_0.tar.bz2'
boost_tarball_sha256sum="${boost_tarball_sha256sum=${boost_tarball_sha256sum_1_78_0}}"
# boost_tarball_sha256sum="${boost_tarball_sha256sum=${boost_tarball_sha256sum_1_81_0}}"
